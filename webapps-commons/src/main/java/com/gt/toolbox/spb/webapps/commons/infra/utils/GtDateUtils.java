 ...
 */
public class GtDateUtils implements Serializable {

	private static final Logger LOG = LoggerFactory.getLogger(GtDateUtils.class);
	...
	public static final DateTimeFormatter DTF_SLASH_DMYY = DateTimeFormatter.ofPattern("dd/MM/yyyy");

	public static final DateTimeFormatter DTF_SLASH_DMYHM = DateTimeFormatter.ofPattern("dd/MM/yy HH:mm");

	public static final DateTimeFormatter DTF_SLASH_DMYHMS = DateTimeFormatter.ofPattern("dd/MM/yy HH:mm:ss");

	public static final DateTimeFormatter DTF_SLASH_DMYYHM = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");

	public static final DateTimeFormatter DTF_SLASH_DMYYHMS = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");

	public static final DateTimeFormatter DTF_ISO8601 = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss.SSSXXX");

	public static final DateTimeFormatter DTF_ISO_YYMD = DateTimeFormatter.ofPattern("yyyyMMdd");

	public static final DateTimeFormatter DTF_ISO_YYMDHMS = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
	...
	public static final DateTimeFormatter DTF_SLASH_ISO_YYMDHM = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm");

	public static final DateTimeFormatter DTF_BAR_ISO_YMD = DateTimeFormatter.ofPattern("yy-MM-dd");

	public static final DateTimeFormatter DTF_BAR_ISO_YYMD = DateTimeFormatter.ofPattern("yyyy-MM-dd");

	public static final DateTimeFormatter DTF_BAR_ISO_YYMDHMS = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

	public static final DateTimeFormatter[] LOCAL_DATE_FORMATS = new DateTimeFormatter[] { DTF_SLASH_DMY,
			DTF_SLASH_DMYY };

	public static final DateTimeFormatter[] LOCAL_DATE_TIME_FORMATS = new DateTimeFormatter[] { DTF_SLASH_DMYHM,
			DTF_SLASH_DMYHMS, DTF_SLASH_DMYYHM,
	...
	public static final NumberFormat CURRENCY_FORMAT = NumberFormat.getCurrencyInstance(Locale.forLanguageTag("es-AR"));
